...
def load_args():
    ...
    arg_parser.add_argument('--input_dir_A', default='datasets/grass')                  # Directory of input domain A
    arg_parser.add_argument('--input_dir_B', default='datasets/icy')                  # Directory of input domain B
